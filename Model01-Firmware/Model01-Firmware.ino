...
KEYMAPS(
  ...
  (___, ___, ___, ___, ___, ___, ___,
   ...
   Key_UpArrow,                    ___, Key_0, Key_Period, Key_KeypadMultiply, Key_KeypadDivide,   Key_Enter,
   ___, Key_LeftArrow, Key_DownArrow, Key_RightArrow,
   ___),

  [FUNCTION] =  KEYMAP_STACKED
  (___,      Key_F1,           Key_F2,      Key_F3,       Key_F4,        Key_F5,           M(LEDS_OFF),
   Key_Tab,  Key_mouseUp,      M(TAB_LEFT), Key_mouseBtnR, M(TAB_RIGHT), Key_mouseWarpEnd, Key_mouseWarpNE,
...
static kaleidoscope::plugin::LEDSolidColor tWhite(200, 200, 200);
